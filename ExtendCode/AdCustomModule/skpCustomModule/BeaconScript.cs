...
namespace skpCustomModule
{
	...
	public class BeaconScript : AddScriptBase
	{
		...
		{
			this.markerG = ModResource.GetTexture("marker-green");
			this.markerB = ModResource.GetTexture("marker-blue");
			this.markerR = ModResource.GetTexture("marker-red");
			this.markerG_info = ModResource.GetTexture("marker-green_info");
			this.markerB_info = ModResource.GetTexture("marker-blue_info");
			this.markerR_info = ModResource.GetTexture("marker-red_info");
			this.marker_progress_BG = ModResource.GetTexture("marker_progress_bg");
			this.marker_progress_G = ModResource.GetTexture("marker_progress_green");
			this.marker_progress_R = ModResource.GetTexture("marker_progress_red");
			this.marker_entity = ModResource.GetTexture("marker_entity");
			this.diamarkerG = ModResource.GetTexture("diamarker-green");
			this.hud_left = ModResource.GetTexture("hud_left");
			this.hud_right = ModResource.GetTexture("hud_right");
			this.hud_center = ModResource.GetTexture("hud_center");
			this.hud_center_in = ModResource.GetTexture("hud_center_in");
			this.hud_center_out = ModResource.GetTexture("hud_center_out");
			this.hud_red_left = ModResource.GetTexture("hud_red_left");
			this.hud_red_right = ModResource.GetTexture("hud_red_right");
			this.hud_red_center = ModResource.GetTexture("hud_red_center");
			this.hud_green_out = ModResource.GetTexture("hud_green_out");
			this.hud_green_in = ModResource.GetTexture("hud_green_in");
			this.hud_blue_out = ModResource.GetTexture("hud_blue_out");
			this.hud_blue_in = ModResource.GetTexture("hud_blue_in");
			this.hud_red_out = ModResource.GetTexture("hud_red_out");
			this.hud_red_in = ModResource.GetTexture("hud_red_in");
			this.hud_direction_mask = ModResource.GetTexture("hud_direction_mask");
			this.hud_direction = ModResource.GetTexture("hud_direction");
			this.hud_horizon = ModResource.GetTexture("hud_horizon");
			this.hud_altitude = ModResource.GetTexture("hud_altitude");
			this.hud_altitude_mask = ModResource.GetTexture("hud_altitude_mask");
			this.hud_speed = ModResource.GetTexture("hud_speed");
			this.hud_speed_mask = ModResource.GetTexture("hud_speed_mask");
			this.team_icon = ModResource.GetTexture("team_icon");
			this.sq_white = ModResource.GetTexture("sq_white");
			...
			ModAudioClip audioClip = ModResource.GetAudioClip("alert");
			bool flag5 = AdCustomModuleMod.mod2.AdSeAudioSourceContainer.ContainsKey("alert");
			if (flag5)
			{
				AdCustomModuleMod.mod2.AdSeAudioSourceContainer["alert"] = audioClip;
			}
			else
			{
				AdCustomModuleMod.mod2.AdSeAudioSourceContainer.Add("alert", audioClip);
			}
			audioClip = ModResource.GetAudioClip("lock");
			bool flag6 = AdCustomModuleMod.mod2.AdSeAudioSourceContainer.ContainsKey("lock");
			if (flag6)
			{
				AdCustomModuleMod.mod2.AdSeAudioSourceContainer["lock"] = audioClip;
			}
			else
			{
				AdCustomModuleMod.mod2.AdSeAudioSourceContainer.Add("lock", audioClip);
			}
			audioClip = ModResource.GetAudioClip("locking");
			bool flag7 = AdCustomModuleMod.mod2.AdLoopAudioSourceContainer.ContainsKey("locking");
			if (flag7)
			{
				AdCustomModuleMod.mod2.AdLoopAudioSourceContainer["locking"] = audioClip;
			}
			else
			{
				AdCustomModuleMod.mod2.AdLoopAudioSourceContainer.Add("locking", audioClip);
			}
